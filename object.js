...
//  returns a new array containing the names of all people
...
const people = [
  ...
  function getNames(people) {
    let adults=people.filter(person=>person>=18). map(person=>
      person.name)
      return adults
  ...
  //  each object represents a productwith a name, price, and
  //  category property.  The function should return an object
  //  that groups the products by their categories,  with
  //  the category names as keys and the arrays of products 
  // as values.
